    ...
    <div class="basicGood-page" v-cloak v-show="showBasicPage">
      ...
      <div class="dishes">
        <template v-cloak v-if="basicGoodArr.length>0">
          ...
          <div class="col-xs-6 col-sm-4 col-md-4 col-lg-3 basicGoodItem" style="padding: 0;" v-for="(item,index) in basicGoodArr" :key="index">
    ...
    <div class="addedGood-page" v-cloak v-show="showAddedPage">
      ...
      <div class="dishes">
        <template v-cloak v-if="addedGoodArr.length>0">
          ...
          <div class="col-xs-6 col-sm-4 col-md-4 col-lg-3 addedGoodItem" style="padding: 0;" v-for="(item,index) in addedGoodArr" :key="index">
            <div class="dishes_item">
