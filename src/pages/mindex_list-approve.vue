<template>
  <div class="warp_main">
    ...
    <div class="button_btn">
      ...
      <router-link class="mindex_tab mycolor" to="/mlogin/mindexlistApprove" style="font-size: 1em;"><i class="iconfont icon-liebiao"></i><br>审批管理</router-link>
    </div>
...
<script>
  ...
  export default {
    ...
    activated() {
      this.waitingOrderMet(3, this.nowState);
    },
    methods: {
