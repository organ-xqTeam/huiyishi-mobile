        ...
        <table class="mindex_table">
          ...
          <template v-cloak v-if="Number(isDockingState)==1">
            <tr>
              ...
              <td>
                <input class="mindex_input form-control" id='datetime' type="type" name="" v-model="ocdockingtime" readonly="readonly" style="background-color:#fff;border:none;ouline:none;box-shadow:none;padding-left:0;color:#000;">
              </td>
            </tr>
            <tr>
